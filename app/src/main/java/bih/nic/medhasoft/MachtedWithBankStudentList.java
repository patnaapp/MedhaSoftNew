...
public class MachtedWithBankStudentList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataBaseHelper = new DataBaseHelper(MachtedWithBankStudentList.this);

        pd1 = new ProgressDialog(MachtedWithBankStudentList.this);
...
//                    new LoadAttendance(_diseCode,_varClass_Id).execute();
        ...
        Userid = PreferenceManager.getDefaultSharedPreferences(MachtedWithBankStudentList.this).getString("UserId", "");
        try {
            blockcode = PreferenceManager.getDefaultSharedPreferences(MachtedWithBankStudentList.this).getString("Block", "");
            distcode = PreferenceManager.getDefaultSharedPreferences(MachtedWithBankStudentList.this).getString("District", "");
            panchyatcode = PreferenceManager.getDefaultSharedPreferences(MachtedWithBankStudentList.this).getString("PanchayatCode", "");
            DistName = PreferenceManager.getDefaultSharedPreferences(MachtedWithBankStudentList.this).getString("DistrictName", "");
            blockName = PreferenceManager.getDefaultSharedPreferences(MachtedWithBankStudentList.this).getString("BlockName", "");
            PanchayatName = PreferenceManager.getDefaultSharedPreferences(MachtedWithBankStudentList.this).getString("PanchayatName", "");
    ...
    {
        localDB = new DataBaseHelper(MachtedWithBankStudentList.this);
        ...
        if(ClassList.size()>0 ) {
            ...
            if (Utiilties.isOnline(MachtedWithBankStudentList.this)) {
                Toast.makeText(this, "Please wait downloading class", Toast.LENGTH_SHORT).show();
                new LoadClassList().execute();

            } else {

                AlertDialog.Builder ab = new AlertDialog.Builder(MachtedWithBankStudentList.this);
    ...
    private class LoadClassList extends AsyncTask<String, Void, ArrayList<CLASSLIST>> {
        ...
        protected void onPreExecute() {
            pd2 = new ProgressDialog(MachtedWithBankStudentList.this);
        ...
        protected void onPostExecute(ArrayList<CLASSLIST> result) {
            ...
            if (result != null) {
                if (result.size() > 0) {
                    ...
                    if(i>0){
                        Toast.makeText(MachtedWithBankStudentList.this, "Class Data downloaded", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(MachtedWithBankStudentList.this, "not inserted", Toast.LENGTH_SHORT).show();
                    }
        ...
        protected void onPostExecute(ArrayList<SESSIONLIST> result) {
            ...
            if (result != null) {
                if (result.size() > 0) {
                    ...
                    if(i>0){
                        Toast.makeText(MachtedWithBankStudentList.this, "Section Data downloaded...", Toast.LENGTH_SHORT).show();
                        ClassList = helper.getClassList();
                        if(ClassList.size()> 0){
                            loadSessionList();
                        }
    ...
    public void searchStdList()
    {
        ...
        if (benfiLists.size() == 0) {
            ...
            recyclerViewAdapter = new SerBList(MachtedWithBankStudentList.this, benfiLists);
