...
public class SearchAdapter extends BaseAdapter{
	...
	ShorCutICON ico;
	String showWhat;
	public SearchAdapter(Context context, String sWhat) {
		mContext = context;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		View vi = convertView;
		if (convertView == null)
			vi = (RelativeLayout) mLayoutInflater.inflate(R.layout.grid_view_search_item,	null);
...
//		TextView txtdob = (TextView) vi.findViewById(R.id.textView_dob);
		...
		TextView textSlNo = (TextView) vi.findViewById(R.id.textSlNo);
...
//			txt_Handi.setText(hand);
		...
		{
//            holder.txtfn.setText(country.getStdfnamehn());
//            holder.txtname.setText(country.getStdnamehn());
//            holder.txtadnum.setText(country.getStdadmnum());

			String fn=mEntries.get(position).getStdfnamehn();
			if(fn!=null)
			{
				fn=!mEntries.get(position).getStdfnamehn().contains("anyType{}") ? mEntries.get(position).getStdfnamehn() : "";
			}
			txtfn.setText(fn);

//			String mn=mEntries.get(position).getStdmnamehn();
//			if(mn!=null)
//			{
//				mn=!mEntries.get(position).getStdmnamehn().contains("anyType{}") ? mEntries.get(position).getStdmnamehn() : "";
//			}
//			txtmn.setText(mn);
//
//			String dob=mEntries.get(position).getStdDOB();
...
//			txtdob.setText(dob);
			...
			String sn=mEntries.get(position).getStdnamehn();
			if(sn!=null)
			{
				sn=!mEntries.get(position).getStdnamehn().contains("anyType{}") ? mEntries.get(position).getStdnamehn() : "";
			}
			txtname.setText(sn);
...
//			txt_Handi.setText(hand);
		...
		int pos = position+1;
		textSlNo.setText(Integer.toString(pos));
		pos++;
		return vi;
	}
